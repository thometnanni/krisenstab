...
![wifi](/media/wifi3.png)
![wifi](/media/wifi4.png)
...
This observation is further explored in «[Not a Network](https://not-a-network.thometnanni.net/)», which features a custom WiFi network that gradually performs poetry by altering its own name. «Not a Network» operates on a WiFi-enabled Arduino and is best experienced by scanning networks from an individual’s own device.

<img src="/media/wifi4.png" style="max-width:300px"/>
