...
<main class="mx-auto max-w-screen-3xl mt-2 px-1 text-black text-balance">
        ...
        {#if p.media?.length > 0 || p.summaryHtml}
          <a href={`/projects/${p.slug}`} class="block">
            <Gallery>
              ...
              >
                <div class="space-y-3 h-[350px] px-1">
                  <div class="grid grid-cols-[auto,1fr] text-left">
                    ...
                    <div class="text-black overflow-hidden">
                      <div class="text-2xl leading-[1.1] break-words">
                        {p.title}
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    class="content text-[.9rem] leading-[1.2] text-wrap"
                  >
                    {@html p.summaryHtml || ""}
                  </div>
                </div>
